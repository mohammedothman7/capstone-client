...
function AllGamesView(props) {
  ...
  return (
    ...
    <div className="col-2 "> 
     ...
     <button className="btn btn-outline-danger">Popular in 2020</button>
     <button className="btn btn-outline-danger">All Time Greatest</button>
     ...
     <button className="btn btn-outline-danger">Last 30 days</button>
      </div>
    ...
    <select className="btn btn-outline-danger mt-2">
      ...
      <div className = "row row-cols-1 row-cols-md-3 pt-4">
        {props.games.map((game) => {
          return (
            <div className = "col mb-4 parentContainer" key={game.id} onClick={props.onClickDiv}>
              <div className ="card">
              <img
      ...
      <button className="btn btn-outline-danger" onClick={props.handleFilter({ page: -2 })}>Previous Page</button>
      <button className="btn btn-outline-danger ml-2" onClick={props.handleFilter({ page: -1 })}>Next Page</button>
      </div>
    </div>
    </div>
